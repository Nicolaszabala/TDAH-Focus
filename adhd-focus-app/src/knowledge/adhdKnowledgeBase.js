 ...
 * Este conocimiento se usa por el asistente offline cuando no hay conexión al LLM
 */

import { SCATTERED_MINDS_CONCEPTS } from './scatteredMindsConcepts';

export const ADHD_KNOWLEDGE = `
...
/**
 * Get ADHD knowledge to use in offline mode
 * @returns {string} - Knowledge base content
 */
export function getADHDKnowledge() {
 ...
 */
export function getKnowledgeSection(topic) {
